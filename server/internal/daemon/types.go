...
type Task struct {
	...
	AskOnly                       bool                   `json:"ask_only,omitempty"`                         // CR-2026-008: project-bound Private Ask chat task — read-only sandbox: no Repositories brief section, `multica repo checkout` rejected
