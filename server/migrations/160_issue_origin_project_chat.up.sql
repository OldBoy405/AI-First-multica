...
--     pattern as 060/111/131/149). origin_id stays NULL — unlike the other
...
ALTER TABLE issue ADD CONSTRAINT issue_origin_type_check
    CHECK (origin_type IN ('autopilot', 'quick_create', 'lark_chat', 'slack_chat', 'agent_create', 'project_chat'));
