		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/projects", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Post("/presenter/approve", h.ApprovePresenter)
					r.Post("/presenter/reject", h.RejectPresenter)
					r.Post("/presenter/transfer", h.TransferPresenter)
					r.Post("/presenter/revoke", h.RevokePresenter)
					r.Post("/presenter/release", h.ReleasePresenter)
