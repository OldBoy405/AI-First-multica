...
func runRepoCheckout(cmd *cobra.Command, args []string) error {
	...
	// AIFIRST: CR-2026-008 — the checkout credential is the task-scoped token the daemon issued to this process;
	// upstream now carries it in the Authorization header and rejects an empty token.
